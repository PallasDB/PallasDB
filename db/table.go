...
func (tx *DBTX) execStmt(stmt any) (r SQLResult, err error) {
...
func matchAllEq(cond any, out []NamedCell) ([]NamedCell, bool) {
...
func matchRange(schema *Schema, cond any) (*RangeReq, bool) {
...
func makeRange(schema *Schema, cond any) (*RangeReq, error) {
...
func (tx *DBTX) execCond(schema *Schema, cond any) (*RowIterator, error) {
